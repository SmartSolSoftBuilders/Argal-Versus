...
<head>
	...
	<script src="../../static/js/v2.0/app/clientes/Clientes.js"></script>	
		...
		<div id="contentContainer" class="clearfix" align="center">
			...
			<section id="pageSection" >			
			  <div class="form-group">
			  	<h5><img src="../../static/img/v2.0/img/cliente.png" height="30" width="30" id="imgImplants" name="imgImplants"/>CATÁLOGO DE CLIENTES
			  		
			  		<br><a href="#" onclick="agregarClienteShow()"><img src="../../static/img/v2.0/img/cliente.png" height="30" width="30" id="imgCte12" name="imgCte12"/>Nuevo Cliente</a>
			  	</h5>
			  	
			    <form id="allclientesforms" name="allclientesforms" class="register" method="post">
