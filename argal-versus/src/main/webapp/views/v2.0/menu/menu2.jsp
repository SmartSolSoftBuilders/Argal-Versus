<ul id="menu">
	...
	<li><a href="#" onclick="location.href='/argal-versus?p=1';">
		<img src="../../static/img/v2.0/img/home.png" width="30" height="30" onclick="location.href='/argal-versus?p=1';">Volver al Inicio</a>
		<ul>							
		</ul></li>
	<li>	
</ul>